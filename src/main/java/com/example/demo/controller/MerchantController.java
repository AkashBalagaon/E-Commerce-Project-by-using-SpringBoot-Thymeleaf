...
public class MerchantController {
	...
	public String updateProduct(@Valid ProductDto produDto,BindingResult result,Model model,
			                    @RequestParam("id") Long id,HttpSession session)
	{
		return merchantService.updateProduct(id,produDto,result,model,session);
	}
